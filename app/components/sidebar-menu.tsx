    ...
    return (
        ...
        <div className="">
            ...
            {item.submenu ? (
                            ...
                            {item.subMenuItems?.map((subItem, idx) => {
                                ...
                                return (
                                    ...
                                    <Link
                                        ...
                                        className={`flex space-x-2 ${locale + subItem.path === pathname ? 'font-bold' : ''
                                            }`}
                                    >
                                        <Image
                                            src={subItem.icon!}
                ...
                <Link
                    href={item.path!}
                    className={`flex flex-row space-x-4 items-center p-2 rounded-lg hover:bg-zinc-100 ${item.path === locale + pathname ? 'bg-zinc-100' : ''
                        }`}
                >
                    <Image
                        src={item.icon!}
